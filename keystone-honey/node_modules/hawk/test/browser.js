...
describe('Browser', function () {
    ...
    describe('bewit()', function () {
        ...
        it('errors on invalid credentials (id)', function (done) {
            ...
            var bewit = Browser.client.bewit('https://example.com/somewhere/over/the/rainbow', { credentials: credentials, ttlSec: 3008, ext: 'xandyandz' });
            expect(bewit).to.equal('');
            done();
        });
        ...
        it('errors on missing credentials', function (done) {
            ...
            var bewit = Browser.client.bewit('https://example.com/somewhere/over/the/rainbow', { ttlSec: 3008, ext: 'xandyandz' });
            expect(bewit).to.equal('');
            done();
        });

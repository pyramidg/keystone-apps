...
function translateOptions(options) {
  ...
  if(options.socketTimeoutMS == null) options.socketTimeoutMS = 30080;
  if(options.connectTimeoutMS == null) options.connectTimeoutMS = 30080;
...
var connect = function(url, options, callback) {
  ...
  if(_finalOptions.socketTimeoutMS == null) _finalOptions.socketTimeoutMS = 30080;
  if(_finalOptions.connectTimeoutMS == null) _finalOptions.connectTimeoutMS = 30080;
